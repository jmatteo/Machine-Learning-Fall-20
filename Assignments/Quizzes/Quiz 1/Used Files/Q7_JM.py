...
Original file is located at
    https://colab.research.google.com/drive/10OFfe_qr2JMHhc6C27GNQrcpDj6YzMJ3
"""
...
raw_text = fClean_Load('sample_data/AToTC.txt')
...
pp1 = [math.exp(x) for x in data[:, 0]]
plt.plot(epochs_lst, pp1, label='k='+str(seq_length))
plt.legend()
plt.xlabel('Epochs')
